...
class _SellerSettingsState extends State<SellerSettings> {
  ...
  Widget build(BuildContext context) {
    final List<_AppSettingItem> settings = [
      _AppSettingItem(
        title: S.of(context).auto_accept_orders,
        subtitle: '',
        isAutoAcceptOrdersToggle: true,
      ),
      _AppSettingItem(
        title: S.of(context).shop_wallet,
        subtitle: S.of(context).shop_wallet_tip,
        widget: const Wallet(),
      ),
    ];
